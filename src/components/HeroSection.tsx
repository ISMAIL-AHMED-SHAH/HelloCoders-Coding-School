...
function HeroSection() {
  return (
    <div
      className="h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-20 md:py-0 text-white"
...
>
  <span
    className="bg-gradient-to-r from-purple-500 to-neutral-400 bg-clip-text text-transparent"
  >
    Hello
  </span> {""}
  Coders Coding School
</h1>
